...
import CV_MERN from "../../Assets/pdfs/FOUDI_CV.pdf";
import PHP_Laravel_CV from "../../Assets/pdfs/CV_2024-12-25_AHMED_FOUDI.pdf";
      ...
      <Container fluid className="resume-section">
        ...
        <Container>
          ...
          <Row className="resume" style={{ justifyContent: "center" }}>
            ...
            <Col md={6}>
              <h3 className="text-center">Developpeur FullStack Java</h3>
